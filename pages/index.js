...
export default function Home() {
  return (
    ...
    <title>Riekus Ritskes - 22   Resume </title>
  </Head>
  ...
  <body>
    <main class="font-firago hyphens-manual">
      {/* <!-- Page --> */}
      <div
        class="max-w-2xl p-6 mx-auto bg-white  page print:max-w-a4 md:max-w-a4 md:h-a4 xsm:p-8 sm:p-9 md:p-16"
      >
        {/* <!-- Name --> */}
        <header class="flex items-center mb-8 md:mb-11">
          <div
            class="px-3 mr-5 text-logobase font-medium leading-none text-white bg-gray-700  initials-container print:bg-black"
          ...
          {/* <!-- <h1 class="pb-px text-2xl font-semibold text-gray-750">
            Riekus Ritskes
          </h1> --> */}
          <div class="block">
            ...
            <h3
              class="m-0 mt-0 font-semibold leading-snug text-md text-gray-550"
            >
...
{/* 
          ...
          <section class="mt-8 first:mt-0">
            ...
            <section class="mb-4.5 break-inside-avoid">
              ...
              <p class="mt-2.1 text-md text-gray-700 leading-normal">
                ...
                therefore never appears antiquated.<br />
      ...
      {/* <!-- Page --> */}
      <div
        class="max-w-2xl p-6 mx-auto bg-gray-100  page print:max-w-a4 md:max-w-a4 md:h-a4 xsm:p-8 sm:p-9 md:p-16 print:bg-white"
      >
        {/* <!-- Column --> */}
        <div
